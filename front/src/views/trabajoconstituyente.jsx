...
const TrabajoConstituyente = props => {
    return (
        <div className="trabajoConstituyente col-md-8 offset-md-2 my-5 py-5 no-gutters" id="constituciondefuturo">
            ...
            <div className="row pt-5 no-gutters">
                <div className="col-12 col-md-6  px-5 no-gutters">
                    <div className="pensamiento d-flex no-gutters">
                ...
                <div className="col-12 col-md-6  px-5 no-gutters">
                    <div className="pensamientocont  pl-4 d-flex no-gutters">
            ...
            <div className="row ml-3 no-gutters">
                <h3 className="blueh3 no-gutters">UNA CONSTITUCIÓN QUE PONGA A <span className="redh3 no-gutters">LA PERSONA EN EL CENTRO</span></h3>
            </div>
        </div >
    );
}
