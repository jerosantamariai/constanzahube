...
const Pensamiento = props => {
    return (
        <>
            <div className="pensamiento col-md-10 offset-md-1 my-5 no-gutters" id="pensamiento">
                ...
                <div className="row d-flex justify-content-center no-gutters">
                    <div className="col-12 col-md-2 no-gutters px-2">
                        <hr />
                        <img src={Piensa1} alt="piensa1" className="piensa1 mt-3" />
                    ...
                    <div className="col-12 col-md-2 no-gutters px-2">
                        <hr />
                        <img src={Piensa2} alt="piensa2" className="piensa2 mt-3" />
                    ...
                    <div className="col-12 col-md-2 no-gutters px-2">
                        <hr />
                        <img src={Piensa3} alt="piensa3" className="piensa3 mt-3" />
                    ...
                    <div className="col-12 col-md-2 no-gutters px-2">
                        <hr />
                        <img src={Piensa4} alt="piensa4" className="piensa4 mt-3" />
                    ...
                    <div className="col-12 col-md-2 no-gutters px-2">
                        <hr />
                        <img src={Piensa5} alt="piensa5" className="piensa5 mt-3" />
            ...
            <img src={Cierre} alt="una_constitucion_para_ti" className="cierrepiensa pb-5 no-gutters" />
        </>
    );
}
