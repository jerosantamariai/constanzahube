    ...
    return (
        <div className="acercaDeMi d-flex justify-content-center">
            ...
            <div className="mensaje">
                <h3>Soy Constanza Hube y quiero ser constituyente.</h3>
                ...
                <p>Tengo un Magíster en Derecho Público, trabajé en el estudio de abogados Carey y soy directora del Foro Constitucional UC. Tengo la experiencia necesaria para escribir la constitución que Chile necesita. Una constitución que ponga a la persona en el centro, que defienda a la familia, incentive la participación privada y regule los límites del Estado.</p>
