...
const AcercaDeMi = props => {
    return (
        <div className="acercaDeMi no-gutters" id="acercademi">
            <div className="row yo-top d-flex no-gutters">
                <div className="col-7 col-md-5 text-justify mens1">
                ...
                <div className="col-12 col-md-6 ml-1 my-5 foto">
                    <img src={ConiHube} alt="Constanza Hube" className="fotoConiHube" />
                </div>
            </div>
            <div className="mens2 text-justify">
            ...
            <div className="cierre d-flex justify-content-center py-5">
                <img src={Cierre} alt="una_constitucion_para_ti" className="cierreacercademi"/>
            </div>
        </div>
    );
}
